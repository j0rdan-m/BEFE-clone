...
<body class="body-post">
    <main class="h-full w-full bg-gray-50 flex items-center justify-center">
        <div class="border max-w-screen-md bg-white mt-6 rounded-2xl p-4 card">
            <div class="flex items-center	justify-between">
                <div class="gap-3.5	flex items-center ">
                    ...
                    <div class="flex flex-col">
                        <b class="mb-2 capitalize text-style">sofia müller</b>
            ...
            <div class="whitespace-pre-wrap mt-7 text-style">Hello guys 🥰</div>
            <div class="mt-5 flex gap-2	 justify-center border-b pb-4 flex-wrap	">
                ...
                <div class=" h-16 border-b  flex items-center justify-around	">
                    ...
                    <div class="flex items-center	gap-3">
                        ...
                        <div class="text-sm text-style">5 Likes</div>
                    </div>
                    <div class="flex items-center	gap-3">
                        ...
                        <div class="text-sm text-style">Share</div>
                    </div>
