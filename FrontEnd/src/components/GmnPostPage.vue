<template>
    <div>
        ...
        <div class="main_postpage">
            ...
            <div class="modal">
                <div class="image_link rounded-2xl shadow-lg">
                    <input id="imageValue" class="flex-grow outline-none" type="text" placeholder="Copy link here..." />
                    <p><button class="btn" @click="addImage">Update</button></p>
...
export default {
    ...
    methods: {
        AddNewPost () {
            ...
            this.createPost({userId: $userIdValue, title: $titleValue, description: $descriptionValue});
        },
        addImage () {
            let $imageValue = document.querySelector("#imageValue").value;

            this.addImage({imageUrl: $imageValue});
        },
